...
// Cada no da arvore avl (estrutura colecaoFilmes) tem uma heap
//Esta heap estara organizada de acordo com o rating (em caso de empate, ver o maior id, que significa que o filme e mais recente)

//Estrutura que vai auxiliar a funcao 9, e'tambem uma avl, que esta ordenada de forma crescente por ids
// e em cada no temos a informacao do id, a categoria e o rating
